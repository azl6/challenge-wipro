...
- Servidor NGINX de proxy-reverso **(HTTPS)** - **ESSE SERVIDOR FOI PARADO EM 15/04/2022**: https://proxy.wipro.alexthedeveloper.com.br
- Servidor Jenkins para CI/CD **ESSE SERVIDOR FOI PARADO EM 06/04/2022, JÁ QUE ADICIONAVA GASTOS PELA SUA NECESSIDADE DE SER UM t2.small, QUE NÃO É COBERTO PELO FREE-TIER**: http://jenkins.wipro.alexthedeveloper.com.br:8080
- Servidor host da API **(SEM HTTPS)** - **ESSE SERVIDOR FOI PARADO EM 15/04/2022**: http://backend.wipro.alexthedeveloper.com.br
...
⚠️ Por favor, não deixe de acessar a pasta **terraform**! ⚠️
